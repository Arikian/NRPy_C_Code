...
int bah_diagnostics_akv_spin(commondata_struct *restrict commondata, griddata_struct *restrict griddata);
...
void bah_rhs_eval(const commondata_struct *restrict commondata, const params_struct *restrict params, const rfm_struct *restrict rfmstruct,
                  const REAL *restrict auxevol_gfs, const REAL *restrict in_gfs, REAL *restrict rhs_gfs);
void bah_xx_to_Cart(const params_struct *restrict params, const REAL xx[3], REAL xCart[3]);
