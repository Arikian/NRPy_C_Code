    ...
    for (int i2 = NGHOSTS; i2 < NGHOSTS + Nxx2; i2++) {
      ...
      for (int i1 = NGHOSTS; i1 < NGHOSTS + Nxx1; i1++) {
        ...
        for (int i0 = NGHOSTS; i0 < NGHOSTS + Nxx0; i0++) {
          ...
          const REAL FDPart3tmp10 = ((hh) * (hh) * (hh) * (hh));
          const REAL FDPart3tmp11 = hDD00 + 1;
          const REAL FDPart3tmp22 = (1.0 / ((WW) * (WW) * (WW) * (WW)));
          const REAL FDPart3tmp32 = ((hh) * (hh) * (hh));
          const REAL FDPart3tmp39 = ((hh_dD2) * (hh_dD2));
          const REAL FDPart3tmp45 = ((hh_dD1) * (hh_dD1));
          const REAL FDPart3tmp64 = (1.0 / ((WW) * (WW) * (WW)));
          const REAL FDPart3tmp65 = 2 * hh;
          const REAL FDPart3tmp88 = cos(xx1);
          const REAL FDPart3tmp157 = 2 * hh_dD2;
          const REAL FDPart3tmp158 = 2 * hh_dD1;
          const REAL FDPart3tmp166 = ((hh) * (hh));
          const REAL FDPart3tmp3 = ((FDPart3tmp2) * (FDPart3tmp2));
          const REAL FDPart3tmp12 = FDPart3tmp10 * ((hDD12) * (hDD12));
          const REAL FDPart3tmp14 = FDPart3tmp1 * hDD11 + FDPart3tmp1;
          const REAL FDPart3tmp17 = FDPart3tmp1 * ((hDD01) * (hDD01));
          const REAL FDPart3tmp21 = FDPart3tmp2 * hDD02;
          const REAL FDPart3tmp24 = FDPart3tmp1 * FDPart3tmp2;
          const REAL FDPart3tmp33 = FDPart3tmp2 * hDD12;
          const REAL FDPart3tmp52 = FDPart3tmp0 * FDPart3tmp1;
          const REAL FDPart3tmp56 = FDPart3tmp0 * FDPart3tmp11;
          const REAL FDPart3tmp59 = FDPart3tmp2 * hh;
          const REAL FDPart3tmp61 = FDPart3tmp0 * hh;
          const REAL FDPart3tmp71 = 2 * FDPart3tmp64;
          const REAL FDPart3tmp4 = FDPart3tmp1 * FDPart3tmp3;
          const REAL FDPart3tmp13 = FDPart3tmp11 * FDPart3tmp12 * FDPart3tmp3 * FDPart3tmp9;
          const REAL FDPart3tmp25 = FDPart3tmp24 * hDD12;
          const REAL FDPart3tmp29 = FDPart3tmp11 * FDPart3tmp14 * FDPart3tmp22 - FDPart3tmp17 * FDPart3tmp22;
          const REAL FDPart3tmp34 = -FDPart3tmp14 * FDPart3tmp21 * FDPart3tmp22 * hh + FDPart3tmp22 * FDPart3tmp32 * FDPart3tmp33 * hDD01;
          const REAL FDPart3tmp58 = FDPart3tmp0 * FDPart3tmp24;
          const REAL FDPart3tmp67 = FDPart3tmp21 * FDPart3tmp64 * FDPart3tmp65;
          const REAL FDPart3tmp72 = FDPart3tmp71 * partial_D_WW2;
          const REAL FDPart3tmp75 = FDPart3tmp64 * FDPart3tmp65 * hDD01;
          const REAL FDPart3tmp91 = FDPart3tmp71 * partial_D_WW1;
          const REAL FDPart3tmp98 = 2 * FDPart3tmp24 * FDPart3tmp88;
          const REAL FDPart3tmp105 = FDPart3tmp71 * partial_D_WW0;
          const REAL FDPart3tmp164 = FDPart3tmp0 * hDD01 * hh;
          const REAL FDPart3tmp165 = FDPart3tmp0 * FDPart3tmp21 * hh;
          const REAL FDPart3tmp6 = FDPart3tmp4 * hDD22 + FDPart3tmp4;
          const REAL FDPart3tmp15 = FDPart3tmp4 * ((hDD02) * (hDD02));
          const REAL FDPart3tmp26 = FDPart3tmp1 * FDPart3tmp21 * FDPart3tmp22 * hDD01 - FDPart3tmp11 * FDPart3tmp22 * FDPart3tmp25;
          const REAL FDPart3tmp68 = FDPart3tmp0 * FDPart3tmp59 * partial_D_hDD202 - FDPart3tmp67 * partial_D_WW2;
          const REAL FDPart3tmp69 = 2 * FDPart3tmp34;
          const REAL FDPart3tmp73 = -FDPart3tmp25 * FDPart3tmp72 + FDPart3tmp58 * partial_D_hDD212;
          const REAL FDPart3tmp76 = FDPart3tmp61 * partial_D_hDD201 - FDPart3tmp75 * partial_D_WW2;
          const REAL FDPart3tmp79 = FDPart3tmp0 * partial_D_hDD200 - FDPart3tmp11 * FDPart3tmp72;
          const REAL FDPart3tmp83 = -FDPart3tmp14 * FDPart3tmp72 + FDPart3tmp52 * partial_D_hDD211;
          const REAL FDPart3tmp86 = FDPart3tmp61 * partial_D_hDD101 - FDPart3tmp75 * partial_D_WW1;
          const REAL FDPart3tmp89 = FDPart3tmp0 * (FDPart3tmp59 * partial_D_hDD102 + FDPart3tmp88 * hDD02 * hh) - FDPart3tmp67 * partial_D_WW1;
          const REAL FDPart3tmp92 =
              FDPart3tmp0 * (FDPart3tmp1 * FDPart3tmp88 * hDD12 + FDPart3tmp24 * partial_D_hDD112) - FDPart3tmp25 * FDPart3tmp91;
          const REAL FDPart3tmp94 = FDPart3tmp0 * partial_D_hDD100 - FDPart3tmp11 * FDPart3tmp91;
          const REAL FDPart3tmp96 = -FDPart3tmp14 * FDPart3tmp91 + FDPart3tmp52 * partial_D_hDD111;
          const REAL FDPart3tmp101 = FDPart3tmp0 * (FDPart3tmp21 + FDPart3tmp59 * partial_D_hDD002) - FDPart3tmp67 * partial_D_WW0;
          const REAL FDPart3tmp103 = FDPart3tmp0 * (hDD01 + hh * partial_D_hDD001) - FDPart3tmp75 * partial_D_WW0;
          const REAL FDPart3tmp106 = FDPart3tmp0 * (FDPart3tmp24 * partial_D_hDD012 + FDPart3tmp33 * FDPart3tmp65) - FDPart3tmp105 * FDPart3tmp25;
          const REAL FDPart3tmp108 = FDPart3tmp0 * partial_D_hDD000 - FDPart3tmp105 * FDPart3tmp11;
          const REAL FDPart3tmp110 =
              FDPart3tmp0 * (FDPart3tmp1 * partial_D_hDD011 + FDPart3tmp65 * hDD11 + FDPart3tmp65) - FDPart3tmp105 * FDPart3tmp14;
          const REAL FDPart3tmp16 = FDPart3tmp14 * FDPart3tmp15 * FDPart3tmp9;
          const REAL FDPart3tmp18 = FDPart3tmp17 * FDPart3tmp6 * FDPart3tmp9;
          const REAL FDPart3tmp36 = 2 * FDPart3tmp26;
          const REAL FDPart3tmp42 = FDPart3tmp22 * FDPart3tmp3 * FDPart3tmp32 * hDD02 * hDD12 - FDPart3tmp22 * FDPart3tmp6 * hDD01 * hh;
          const REAL FDPart3tmp46 = FDPart3tmp11 * FDPart3tmp22 * FDPart3tmp6 - FDPart3tmp15 * FDPart3tmp22;
          const REAL FDPart3tmp48 = -FDPart3tmp12 * FDPart3tmp22 * FDPart3tmp3 + FDPart3tmp14 * FDPart3tmp22 * FDPart3tmp6;
          const REAL FDPart3tmp70 = FDPart3tmp68 * FDPart3tmp69;
          const REAL FDPart3tmp81 = FDPart3tmp0 * FDPart3tmp4 * partial_D_hDD222 - FDPart3tmp6 * FDPart3tmp72;
          const REAL FDPart3tmp90 = FDPart3tmp69 * FDPart3tmp89;
          const REAL FDPart3tmp99 = FDPart3tmp0 * (FDPart3tmp4 * partial_D_hDD122 + FDPart3tmp98 * hDD22 + FDPart3tmp98) - FDPart3tmp6 * FDPart3tmp91;
          const REAL FDPart3tmp102 = FDPart3tmp101 * FDPart3tmp69;
          ...
          const REAL FDPart3tmp19 = 2 * FDPart3tmp10 * FDPart3tmp3 * FDPart3tmp9 * hDD01 * hDD02 * hDD12 +
                                    FDPart3tmp11 * FDPart3tmp14 * FDPart3tmp6 * FDPart3tmp9 - FDPart3tmp13 - FDPart3tmp16 - FDPart3tmp18;
          const REAL FDPart3tmp74 = FDPart3tmp36 * FDPart3tmp73;
          const REAL FDPart3tmp77 = 2 * FDPart3tmp42;
          const REAL FDPart3tmp80 = FDPart3tmp48 * FDPart3tmp79;
          const REAL FDPart3tmp82 = FDPart3tmp29 * FDPart3tmp81;
          const REAL FDPart3tmp84 = FDPart3tmp46 * FDPart3tmp83;
          const REAL FDPart3tmp93 = FDPart3tmp36 * FDPart3tmp92;
          const REAL FDPart3tmp95 = FDPart3tmp48 * FDPart3tmp94;
          const REAL FDPart3tmp97 = FDPart3tmp46 * FDPart3tmp96;
          const REAL FDPart3tmp100 = FDPart3tmp29 * FDPart3tmp99;
          const REAL FDPart3tmp107 = FDPart3tmp106 * FDPart3tmp36;
          const REAL FDPart3tmp109 = FDPart3tmp108 * FDPart3tmp48;
          const REAL FDPart3tmp111 = FDPart3tmp110 * FDPart3tmp46;
          const REAL FDPart3tmp114 = FDPart3tmp113 * FDPart3tmp29;
          const REAL FDPart3tmp20 = (1.0 / (FDPart3tmp19));
          const REAL FDPart3tmp78 = FDPart3tmp76 * FDPart3tmp77;
          const REAL FDPart3tmp87 = FDPart3tmp77 * FDPart3tmp86;
          const REAL FDPart3tmp104 = FDPart3tmp103 * FDPart3tmp77;
          const REAL FDPart3tmp115 = (1.0 / ((FDPart3tmp19) * (FDPart3tmp19)));
          const REAL FDPart3tmp30 = FDPart3tmp20 * FDPart3tmp29;
          const REAL FDPart3tmp47 = FDPart3tmp20 * FDPart3tmp46;
          const REAL FDPart3tmp116 = FDPart3tmp115 * ((FDPart3tmp42) * (FDPart3tmp42));
          const REAL FDPart3tmp117 = FDPart3tmp115 * ((FDPart3tmp46) * (FDPart3tmp46));
          const REAL FDPart3tmp118 = FDPart3tmp115 * ((FDPart3tmp26) * (FDPart3tmp26));
          const REAL FDPart3tmp119 = FDPart3tmp115 * FDPart3tmp26;
          const REAL FDPart3tmp121 = FDPart3tmp115 * FDPart3tmp46;
          const REAL FDPart3tmp123 = FDPart3tmp115 * FDPart3tmp42;
          const REAL FDPart3tmp126 = FDPart3tmp115 * FDPart3tmp48;
          const REAL FDPart3tmp128 = FDPart3tmp115 * FDPart3tmp34;
          const REAL FDPart3tmp136 = FDPart3tmp115 * ((FDPart3tmp34) * (FDPart3tmp34));
          const REAL FDPart3tmp137 = FDPart3tmp115 * ((FDPart3tmp29) * (FDPart3tmp29));
          const REAL FDPart3tmp139 = FDPart3tmp115 * FDPart3tmp29;
          const REAL FDPart3tmp149 = FDPart3tmp115 * ((FDPart3tmp48) * (FDPart3tmp48));
          const REAL FDPart3tmp28 = FDPart3tmp20 * FDPart3tmp26 * hh_dD1;
          const REAL FDPart3tmp41 = FDPart3tmp20 * FDPart3tmp34 * hh_dD2;
          const REAL FDPart3tmp44 = FDPart3tmp20 * FDPart3tmp42 * hh_dD1;
          const REAL FDPart3tmp53 = FDPart3tmp20 * FDPart3tmp26 * hh_dD2;
          const REAL FDPart3tmp120 = FDPart3tmp119 * FDPart3tmp77;
          const REAL FDPart3tmp124 = FDPart3tmp123 * FDPart3tmp34;
          const REAL FDPart3tmp125 = FDPart3tmp123 * FDPart3tmp26;
          const REAL FDPart3tmp129 = FDPart3tmp128 * FDPart3tmp46;
          const REAL FDPart3tmp131 = FDPart3tmp128 * FDPart3tmp26;
          const REAL FDPart3tmp133 = FDPart3tmp123 * FDPart3tmp29;
          const REAL FDPart3tmp138 = FDPart3tmp119 * FDPart3tmp69;
          const REAL FDPart3tmp144 = FDPart3tmp126 * FDPart3tmp26;
          const REAL FDPart3tmp150 = FDPart3tmp128 * FDPart3tmp77;
          const REAL FDPart3tmp155 = 2 * FDPart3tmp20 * FDPart3tmp34;
          const REAL FDPart3tmp156 = 2 * FDPart3tmp20 * FDPart3tmp42;
          const REAL FDPart3tmp35 = FDPart3tmp20 * FDPart3tmp34 - FDPart3tmp28 - FDPart3tmp30 * hh_dD2;
          const REAL FDPart3tmp50 = FDPart3tmp20 * FDPart3tmp36 * hh_dD1 * hh_dD2 + FDPart3tmp20 * FDPart3tmp48 + FDPart3tmp30 * FDPart3tmp39 -
                                    2 * FDPart3tmp41 - 2 * FDPart3tmp44 + FDPart3tmp45 * FDPart3tmp47;
          const REAL FDPart3tmp55 = FDPart3tmp20 * FDPart3tmp42 - FDPart3tmp47 * hh_dD1 - FDPart3tmp53;
          const REAL FDPart3tmp57 = FDPart3tmp20 * FDPart3tmp48 - FDPart3tmp41 - FDPart3tmp44;
          const REAL FDPart3tmp122 = -FDPart3tmp116 * FDPart3tmp94 - FDPart3tmp117 * FDPart3tmp96 - FDPart3tmp118 * FDPart3tmp99 -
                                     FDPart3tmp120 * FDPart3tmp89 - FDPart3tmp121 * FDPart3tmp87 - FDPart3tmp121 * FDPart3tmp93;
          const REAL FDPart3tmp132 =
          ...
          const REAL FDPart3tmp135 = -FDPart3tmp118 * FDPart3tmp73 - FDPart3tmp119 * FDPart3tmp82 - FDPart3tmp119 * FDPart3tmp84 -
          ...
          const REAL FDPart3tmp140 = -FDPart3tmp118 * FDPart3tmp83 - FDPart3tmp136 * FDPart3tmp79 - FDPart3tmp137 * FDPart3tmp81 -
                                     FDPart3tmp138 * FDPart3tmp76 - FDPart3tmp139 * FDPart3tmp70 - FDPart3tmp139 * FDPart3tmp74;
          const REAL FDPart3tmp142 = -FDPart3tmp100 * FDPart3tmp119 - FDPart3tmp118 * FDPart3tmp92 - FDPart3tmp119 * FDPart3tmp97 -
          ...
          const REAL FDPart3tmp146 = FDPart3tmp116 * FDPart3tmp86 + FDPart3tmp123 * FDPart3tmp95 + FDPart3tmp123 * FDPart3tmp97 +
          ...
          const REAL FDPart3tmp148 = FDPart3tmp123 * FDPart3tmp29 * FDPart3tmp73 + FDPart3tmp124 * FDPart3tmp76 + FDPart3tmp125 * FDPart3tmp83 +
          ...
          const REAL FDPart3tmp151 = FDPart3tmp102 * FDPart3tmp126 + FDPart3tmp104 * FDPart3tmp126 + FDPart3tmp106 * FDPart3tmp150 +
                                     FDPart3tmp108 * FDPart3tmp149 + FDPart3tmp110 * FDPart3tmp116 + FDPart3tmp113 * FDPart3tmp136;
          const REAL FDPart3tmp51 = (1.0 / (FDPart3tmp50));
          const REAL FDPart3tmp85 = (1.0 / sqrt(FDPart3tmp50));
          ...
          const REAL FDPart3tmp63 = 2 * FDPart3tmp51 * FDPart3tmp57;
          const REAL FDPart3tmp153 = (1.0 / 2.0) * FDPart3tmp85;
          const REAL Theta =
